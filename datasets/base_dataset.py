...
import torch
import os,sys 
parentdir = '/home/zzs/zzs/mdsn/metadrive'
sys.path.insert(0,parentdir) 
from metadrive.scenario.scenario_description import MetaDriveType
parentdir = '/home/zzs/zzs/mdsn/scenarionet'
sys.path.insert(0,parentdir) 
...
def draw_figures(cfg):
    ...
    # 保存图像
    img_save_path = "/home/zzs/zzs/UniTraj/picture"  # 你想要保存图像的路径
...
@hydra.main(version_base=None, config_path="/home/zzs/zzs/UniTraj/unitraj/configs", config_name="config")
def split_data(cfg):
    set_seed(cfg.seed)
    OmegaConf.set_struct(cfg, False)  # Open the struct
    cfg = OmegaConf.merge(cfg, cfg.method)
